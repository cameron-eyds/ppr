  ...
  >
    <div>
      <MenuButton class="flex flex-nowrap content-center p-2 hover:bg-bcGovColor-activeBlue/[0.2]">
        ...
        <v-icon
          class="ml-1 self-center text-xl"
        ...
        <div class="divide-y-2 divide-bcGovGray-100 text-bcGovGray-700 min-w-[300px]">
          ...
          >
            <slot :name="'menu-list-header-' + i">
              <h3
                v-if="menuList.header"
                class="px-4 pb-2 font-bold text-bcGovGray-900"
              >
                {{ menuList.header }}
              </h3>
            </slot>
            <HeadlessTestComponent
...
import HeadlessTestComponent from '@/components/common/HeadlessTestComponent.vue'
