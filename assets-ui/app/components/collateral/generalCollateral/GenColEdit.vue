    ...
    const generalCollateralDefaultValue = (): string => {
      switch (getRegistrationType.value.registrationTypeAPI) {
        ...
        case APIRegistrationTypes.SPECULATION_VACANCY_TAX:
            return 'All the debtor’s present and after acquired personal property, including but not restricted to machinery, equipment, furniture, fixtures and receivables.'  
