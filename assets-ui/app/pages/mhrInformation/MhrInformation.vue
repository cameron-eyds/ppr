    ...
    const localState = reactive({
      ...
      alertMsg: computed((): string => {
        ...
        return isRoleStaffReg.value
          ? `A ${unitNoteType} has been filed against this home. This will prevent qualified suppliers from making any changes to this home. See Unit Notes for further details.`  
          : `A ${unitNoteType} has been filed against this home and you will be unable to make any changes. If you require further information please contact BC Registries staff.`  
      }),
